...
final_valid_date = pd.to_datetime(getmtime('example1_adj.xlsx'), unit='s') # Time of last modification
...
for col in sheet_0.columns:
    ...
    if col.find('date') != -1:
        ...
        unambiguous_sheet[col] = line_fill_ambiguous_date(unambiguous_sheet[col], sheet_0[col]) 
...
# %%
unambiguous_sheet.to_excel('example1_cleaned_advanced.xlsx', index=False)
